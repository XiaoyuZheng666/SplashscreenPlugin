...
# cordova-plugin-jb-splashscreen

基于官方5.0.2版本修改，添加了安卓中支持全屏的功能（默认是全屏，没有状态栏），可以通过调用js方法展示出状态栏

## Installation

    // npm hosted (new) id
    cordova plugin add cordova-plugin-jb-splashscreen
...
<preference name="HideStatusBar" value="true" />
```
